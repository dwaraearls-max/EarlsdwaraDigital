...
export function Footer() {
  ...
  return (
    <footer className="relative mt-24 border-t border-border bg-bg-secondary/80">
      <div className="mx-auto grid w-[min(1200px,92%)] gap-12 px-0 py-16 md:grid-cols-2 lg:grid-cols-4">
        <div className="lg:col-span-1">
          <div className="mb-4 flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-highlight to-accent font-display text-sm font-bold text-[#081525]">
              ED
            </span>
